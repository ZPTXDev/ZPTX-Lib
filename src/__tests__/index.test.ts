...
describe('msToTime function', () => {
    test('converts milliseconds to a time object', () => {
...
describe('msToTimeString function', () => {
    test('returns a simple string for less than a day', () => {
    ...
    test('returns "MORE_THAN_A_DAY" for more than a day', () => {
    ...
    test('returns a detailed string for less than a day', () => {
    ...
    test('returns a detailed string for more than a day', () => {
...
describe('parseTimeString function', () => {
    test('parses simple time strings correctly', () => {
...
describe('getBar function', () => {
    it('should return the correct progress bar for progress percentage less than 10', () => {
        expect(getBar(9)).toBe('🔘▬▬▬▬▬▬▬▬▬');
        expect(getBar(5)).toBe('🔘▬▬▬▬▬▬▬▬▬');
        expect(getBar(0)).toBe('🔘▬▬▬▬▬▬▬▬▬');
    });

    it('should return the correct progress bar for progress percentage between 10 and 19', () => {
        expect(getBar(10)).toBe('▬🔘▬▬▬▬▬▬▬▬');
        expect(getBar(15)).toBe('▬🔘▬▬▬▬▬▬▬▬');
        expect(getBar(19)).toBe('▬🔘▬▬▬▬▬▬▬▬');
    });

    it('should return the correct progress bar for progress percentage between 20 and 29', () => {
        expect(getBar(20)).toBe('▬▬🔘▬▬▬▬▬▬▬');
        expect(getBar(25)).toBe('▬▬🔘▬▬▬▬▬▬▬');
        expect(getBar(29)).toBe('▬▬🔘▬▬▬▬▬▬▬');
    });

    it('should return the correct progress bar for progress percentage between 30 and 39', () => {
        expect(getBar(30)).toBe('▬▬▬🔘▬▬▬▬▬▬');
        expect(getBar(35)).toBe('▬▬▬🔘▬▬▬▬▬▬');
        expect(getBar(39)).toBe('▬▬▬🔘▬▬▬▬▬▬');
    });

    it('should return the correct progress bar for progress percentage between 40 and 49', () => {
        expect(getBar(40)).toBe('▬▬▬▬🔘▬▬▬▬▬');
        expect(getBar(45)).toBe('▬▬▬▬🔘▬▬▬▬▬');
        expect(getBar(49)).toBe('▬▬▬▬🔘▬▬▬▬▬');
    });

    it('should return the correct progress bar for progress percentage between 50 and 59', () => {
        expect(getBar(50)).toBe('▬▬▬▬▬🔘▬▬▬▬');
        expect(getBar(55)).toBe('▬▬▬▬▬🔘▬▬▬▬');
        expect(getBar(59)).toBe('▬▬▬▬▬🔘▬▬▬▬');
    });

    it('should return the correct progress bar for progress percentage between 60 and 69', () => {
        expect(getBar(60)).toBe('▬▬▬▬▬▬🔘▬▬▬');
        expect(getBar(65)).toBe('▬▬▬▬▬▬🔘▬▬▬');
        expect(getBar(69)).toBe('▬▬▬▬▬▬🔘▬▬▬');
    });

    it('should return the correct progress bar for progress percentage between 70 and 79', () => {
        expect(getBar(70)).toBe('▬▬▬▬▬▬▬🔘▬▬');
        expect(getBar(75)).toBe('▬▬▬▬▬▬▬🔘▬▬');
        expect(getBar(79)).toBe('▬▬▬▬▬▬▬🔘▬▬');
    });

    it('should return the correct progress bar for progress percentage between 80 and 89', () => {
        expect(getBar(80)).toBe('▬▬▬▬▬▬▬▬🔘▬');
        expect(getBar(85)).toBe('▬▬▬▬▬▬▬▬🔘▬');
        expect(getBar(89)).toBe('▬▬▬▬▬▬▬▬🔘▬');
    });

    it('should return the correct progress bar for progress percentage between 90 and 100', () => {
...
describe('paginate function', () => {
    test('paginates an array of size 10 into pages of size 5', () => {
    ...
    test('paginates an array of size 9 into pages of size 5', () => {
    ...
    test('paginates an array of size 5 into pages of size 3', () => {
        const arr = [1, 2, 3, 4, 5];
    ...
    test('paginates an array of size 4 into pages of size 3', () => {
        const arr = [1, 2, 3, 4];
        const paginated = paginate(arr, 3);
        expect(paginated).toEqual([[1, 2, 3], [4]]);
    });

    test('paginates an empty array', () => {
        const arr: any[] = [];
        const paginated = paginate(arr, 3);
        expect(paginated).toEqual([]);
    });
...
describe('getJSONResponse function', () => {
    test('getJSONResponse should return a parsed JSON object', async () => {
        const body = '{"a": 1, "b": 2}';
        const result = await getJSONResponse(body);
        expect(result).toEqual({ a: 1, b: 2 });
    });

    test('getJSONResponse should throw an error for an empty body', async () => {
        const body = '';
        await expect(getJSONResponse(body)).rejects.toThrow();
    });

    test('getJSONResponse should throw an error for invalid JSON', async () => {
        const body = '{"a": 1, b: 2}';
        await expect(getJSONResponse(body)).rejects.toThrow();
    });
});
